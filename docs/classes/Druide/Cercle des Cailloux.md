...
Lorsque vous commencez votre tour dans un cromlech, vous gagnez un nombre de points de vie temporaire égal à votre modificateur de Sagesse + la moitié de votre niveau de Druide (arrondi à l'inférieur). De plus, vous pouvez choisir n'importe quel nombre d'alliés qui seront également affectés par le cromlech. Une créature que vous choisissez gagne un nombre de points de vie temporaires égal à son modificateur de Sagesse lorsqu'elle commence son tour dans le cromlech. Les points de vie temporaires conférés par le cromlech ne persistent que tant que la créature se trouve dans le cromlech.
