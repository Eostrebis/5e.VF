...
Chaque créature dans un rayon de 20 ft. doit réussir un jet de sauvegarde de Constitution ou subir 2d6 dégâts radieux. Une créature n'a pas besoin d'effectuer ce jet si elle se trouve en couverture totale derrière un objet opaque.
