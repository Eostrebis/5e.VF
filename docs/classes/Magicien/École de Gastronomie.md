...
Si la bouche saisit une cible de taille M ou plus petite au début de votre tour, vous pouvez utiliser votre action bonus pour lui ordonner d'avaler la cible, transportant la cible vers un espace extradimensionnel rempli d'acide. Tant qu'elle est avalée, la cible est [[aveuglé|aveuglée]] et [[retenu|retenue]], prenant 4d6 dégâts d'acide au début de chacun de ses tours. La créature peut utiliser son action pour effectuer un jet de sauvegarde de Force contre votre DD de sort pour s'Échapper. Si elle réussit, elle réapparaît magiquement et tombe [[au sol]] dans un espace inoccupé à 5 ft. de la bouche. La créature s'échappe automatiquement lorsque la bouche disparaît.
