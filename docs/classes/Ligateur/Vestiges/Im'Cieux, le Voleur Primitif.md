...
## Instincts du Voleur
Vous pouvez prendre l'action Désengager, Courir ou Cacher pour une action bonus. Vous pouvez utiliser cette aptitude deux fois et regagnez toutes les utilisations lorsque vous terminez un repos.
