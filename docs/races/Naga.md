...
Si vous touchez avec votre morsure, vous infligez 1d4 + votre modificateur de Force dégâts perçants et votre cible doit effectuer un jet de sauvegarde de Constitution (DD 8 + votre bonus de maîtrise + votre modificateur de Constitution). Si elle échoue, la cible subit 1d4 dégâts de poison.
