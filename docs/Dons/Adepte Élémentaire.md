...
Lorsque vous obtenez ce don, choisissez l'un des types de dégâts suivants : acide, froid, feu, foudre ou tonnerre.
 ...
 - Les sorts que vous lancez ignorent une résistance aux dégâts du type choisi. De plus, lorsque vous lancez les dégâts d'un sort que vous lancez qui inflige des dégâts de ce type, vous considérez les 1 comme des 2 plutôt.
