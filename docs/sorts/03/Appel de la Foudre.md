...
Lorsque vous lancez ce sort, choisissez un point que vous pouvez voir sous le nuage. Un éclair s'abat du nuage sur ce point. Toutes les créatures à 5 ft. de ce point doivent effectuer un jet de sauvegarde de Dextérité. Une créature subit 3d10 dégâts de foudre en cas d'échec, et la moitié en cas de succès. A chacun de vos tours jusqu'à ce que le sort ne termine, vous pouvez utiliser votre action pour appeler la foudre de cette façon.
